...
def main():
    ...
    print_animated_message2 = Animation.animated_text(static_text="", animated_text="I can print fast,", delay_animation= 0.05, hold_thread_for= 0.1)
    print_animated_message2.stop(0.01)
    print_animated_message3 = Animation.animated_text(static_text="I can print fast,", animated_text=" or I can print slow,", delay_animation= 0.2, hold_thread_for= 0.1)
